  ...
  $(document).ready(function() {
    ...
    articleTextarea.on('keydown.ignoreTabs', function(evt) {
      ...
      if (evt.keyCode === 9) {
        ...
        return domTextarea.selectionStart = domTextarea.selectionEnd = start + 1;
      }
    });
    resizeTextarea = function() {
      articleTextarea.get(0).style.height = 'auto';
      return articleTextarea.get(0).style.height = articleTextarea.get(0).scrollHeight + 'px';
    };
